	...
	Q()
		...
		.then(function(){
			...
			_.each(allPlayers, function(dataPlayer, playerNb){	// pour chaque joueur
				...
				dataPlayer.totalpoints= dataPlayer.points.tour1.total + dataPlayer.points.tour2.total + dataPlayer.points.tour3.total + dataPlayer.points.qualif.total + dataPlayer.points.roundOf16.total + dataPlayer.points.quarterFinals.total;
